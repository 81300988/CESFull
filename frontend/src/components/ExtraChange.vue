<template>
    <layout-default :showNav="showNav" isExActive="true">
        <div class="place">
          <tr cellspacing="0" cellpadding="0" class="header_css">
              <td style="border: none;"><h1>PACKAGE TYPE</h1></td>
            ...
            <table>
                ...
                <tr v-if="IsShowAdd">
                    <td><input type="text" v-model="NewPackage"></td>
                    <td><input type="text" v-model="NewFee"></td>
...
export default {
  ...
  created () {
    let currentObj = this
    this.axios.get('http://localhost:53842/Home/Get', {
    })
